 ...
 * The protocol is Productd in the MFRC522 datasheet: http://www.nxp.com/documents/data_sheet/MFRC522.pdf
 *
 ...
 * The MIFARE Classic chips and protocol is Productd in the datasheets:
 *		1K:   http://www.nxp.com/documents/data_sheet/MF1S503x.pdf
 * 		4K:   http://www.nxp.com/documents/data_sheet/MF1S703x.pdf
 * 		Mini: http://www.idcardmarket.com/download/mifare_S20_datasheet.pdf
 * The MIFARE Ultralight chip and protocol is Productd in the datasheets:
...
class MFRC522 {
 public:
  ...
  enum PCD_Register {
    ...
    ErrorReg =
        0x06,  // error bits showing the error status of the last command executed
    ...
    CollReg =
        0x0E,  // bit position of the first bit-collision detected on the RF interface
    ...
    TxControlReg =
        0x14,  // controls the logical behavior of the antenna driver pins TX1 and TX2
    ...
    GsNReg =
        0x27,  // selects the conductance of the antenna driver pins TX1 and TX2 for modulation
    CWGsPReg =
        0x28,  // defines the conductance of the p-driver output during periods of no modulation
    ModGsPReg =
        0x29,  // defines the conductance of the p-driver output during periods of modulation
    TModeReg = 0x2A,  // defines settings for the internal timer
    TPrescalerReg =
        0x2B,  // the lower 8 bits of the TPrescaler value. The 4 high bits are in TModeReg.
  ...
  // Productd in 9.3.3.6 / table 98 of the datasheet at http://www.nxp.com/documents/data_sheet/MFRC522.pdf
  enum PCD_RxGain {
