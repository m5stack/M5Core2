 ...
 * The protocol is Productd in the MFRC522 datasheet:
 ...
 *Ultralight chip and protocol is Productd in the datasheets: Ultralight:
...
class MFRC522 {
   public:
    ...
    // factor (on the PCD). Productd in 9.3.3.6 / table 98 of the datasheet at
    // http://www.nxp.com/documents/data_sheet/MFRC522.pdf
    enum PCD_RxGain {
