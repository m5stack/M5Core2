...
*                          配套  M5Core2 示例源代码
* Visit for more information: https://docs.m5stack.com/en/unit/vibrator
* 获取更多资料请访问: https://docs.m5stack.com/zh_CN/unit/vibrator
*
...
void setup() {
  ...
  M5.Lcd.setCursor(110,
                   10);  //Set the cursor at (110,10).  将光标设置在(110,10)处
