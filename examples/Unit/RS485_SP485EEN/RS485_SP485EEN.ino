...
void setup() {
  ...
  Serial2.begin(
      ...
      TX_PIN);  //Set the baud rate of serial port 2 to 115200,8 data bits, no parity bits, and 1 stop bit, and set RX to 13 and TX to 14.  设置串口二的波特率为115200,8位数据位,没有校验位,1位停止位,并设置RX为13,TX为14
}
