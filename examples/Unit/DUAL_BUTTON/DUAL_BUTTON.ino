...
*                          配套  M5Core2 示例源代码
* Visit for more information: https://docs.m5stack.com/en/unit/dual_button
* 获取更多资料请访问: https://docs.m5stack.com/zh_CN/unit/dual_button
*
* Product: Button_Two.  双按键
* Date: 2021/8/9
*******************************************************************************
  Please connect to Port B,Read the button status of BUTTON Unit and display it
on the screen 请连接端口B,读取按键的状态并在显示屏上显示 if you don't have M5GO
BOTTOM, you need change the pinMode and the digitalRead to 33、32, But you will
not be able to use any I2C operations. 如果你没有M5GO
BOTTOM，你需要改变pinMode和digitalRead到 33,32,但是你将不能使用任何I2C操作.
*/
#include <M5Core2.h>
