...
void setup() {
    ...
    /* 	Serial2.begin(115200, SERIAL_8N1, 13, 14);
      The 13(RX), 14(TX) pins of the CORE2 correspond to the 16(RX), 17(TX) pins
      of the COMX CORE2的13（RX）、14（TX）引脚对应COMX的16（RX）、17（TX）引脚
