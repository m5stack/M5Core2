...
bool AXP2101::set_charger_term_current_to_zero(void)
{
    ...
    result = bitOff(AXP2101_ADDR, AXP2101_CHARGER_SETTING_REG, 0b00001111, _speed);
...
bool AXP2101::set_charger_constant_current_to_50mA(void)
{
    ...
    result = writeRegister8(AXP2101_ADDR, AXP2101_ICC_CHARGER_SETTING_REG, 2, _speed);
...
{   
  ...
  if (temp > 3400)
    temp = 3400;    
  if (writeRegister8(AXP2101_ADDR, AXP2101_DLDO1_VOLTAGE_REG, (temp - 500) / 100, _speed)) {
      return true;
  } else {
      return false;
  }            
...
{   
  ...
  if (temp > 3500)
    temp = 3500;    
  if (writeRegister8(AXP2101_ADDR, AXP2101_ALDO3_VOLTAGE_REG, (temp - 500) / 100, _speed)) {
      return true;
  } else {
      return false;
  }            
...
void AXP2101::set_bat_charge(bool enable)
{
  ...
  if (readRegister(AXP2101_ADDR, 0x18, &val, 1, _speed)) {
    writeRegister8(AXP2101_ADDR, 0x18, (val & 0xFD) + (enable << 1), _speed);
  }
}
...
{
  // 1. AXP2101 Power off
  bitOn(AXP2101_ADDR, 0x41, 1 << 1, 400000);  // POWERON Negative Edge IRQ(ponne_irq_en) enable
  writeRegister8(AXP2101_ADDR, 0x25, 0b00011011, 400000);  // sleep and wait for wakeup
  delay(100);
  writeRegister8(AXP2101_ADDR, 0x10, 0b00110001, 400000);  // power off  
}

bool AXP2101::readRegister(uint8_t addr, uint8_t reg, uint8_t* result, uint16_t length, uint32_t freq)
{
    uint8_t index = 0;
    uint8_t err = 0;
...
bool AXP2101::writeRegister8(uint8_t addr, uint8_t reg, uint8_t data, uint32_t freq)
{
    uint8_t result;
...
{   
  ...
  if (temp > 3500)
    temp = 3500;  
  if (writeRegister8(AXP2101_ADDR, AXP2101_BLDO1_VOLTAGE_REG, (temp - 500) / 100, _speed)) {
      return true;
  } else {
      return false;
  }            
...
{   
  ...
  if (temp > 3500)
    temp = 3500;    
  if (writeRegister8(AXP2101_ADDR, AXP2101_BLDO2_VOLTAGE_REG, (temp - 500) / 100, _speed)) {
      return true;
  } else {
      return false;
  }            
...
bool AXP2101::set_dldo1_on_off(bool sw)
{
    ...
    if (sw) {
        result = bitOn(_addr, AXP2101_LDO_CTRL_REG, AXP2101_DLDO1_CTRL_MASK, _speed);
    } else {
        result = bitOff(_addr, AXP2101_LDO_CTRL_REG, AXP2101_DLDO1_CTRL_MASK, _speed);
    }
...
bool AXP2101::set_cpusldo_on_off(bool sw)
{
    ...
    if (sw) {
        result = bitOn(_addr, AXP2101_LDO_CTRL_REG, AXP2101_CPUSLDO_CTRL_MASK, _speed);
    } else {
        result = bitOff(_addr, AXP2101_LDO_CTRL_REG, AXP2101_CPUSLDO_CTRL_MASK, _speed);
    }
...
bool AXP2101::set_blod2_on_off(bool sw)
{
    ...
    if (sw) {
        result = bitOn(_addr, AXP2101_LDO_CTRL_REG, AXP2101_BLDO2_CTRL_MASK, _speed);
    } else {
        result = bitOff(_addr, AXP2101_LDO_CTRL_REG, AXP2101_BLDO2_CTRL_MASK, _speed);
    }
...
bool AXP2101::set_bldo1_on_off(bool sw)
{
    ...
    if (sw) {
        result = bitOn(_addr, AXP2101_LDO_CTRL_REG, AXP2101_BLDO1_CTRL_MASK, _speed);
    } else {
        result = bitOff(_addr, AXP2101_LDO_CTRL_REG, AXP2101_BLDO1_CTRL_MASK, _speed);
    }
...
bool AXP2101::set_aldo4_on_off(bool sw)
{
    ...
    if (sw) {
        result = bitOn(_addr, AXP2101_LDO_CTRL_REG, AXP2101_ALDO4_CTRL_MASK, _speed);
    } else {
        result = bitOff(_addr, AXP2101_LDO_CTRL_REG, AXP2101_ALDO4_CTRL_MASK, _speed);
    }
...
bool AXP2101::set_aldo3_on_off(bool sw)
{
    ...
    if (sw) {
        result = bitOn(_addr, AXP2101_LDO_CTRL_REG, AXP2101_ALDO3_CTRL_MASK, _speed);
    } else {
        result = bitOff(_addr, AXP2101_LDO_CTRL_REG, AXP2101_ALDO3_CTRL_MASK, _speed);
    }
...
bool AXP2101::set_aldo2_on_off(bool sw)
{
    ...
    if (sw) {
        result = bitOn(_addr, AXP2101_LDO_CTRL_REG, AXP2101_ALDO2_CTRL_MASK, _speed);
    } else {
        result = bitOff(_addr, AXP2101_LDO_CTRL_REG, AXP2101_ALDO2_CTRL_MASK, _speed);
    }
...
bool AXP2101::set_aldo1_on_off(bool sw)
{
    ...
    if (sw) {
        result = bitOn(_addr, AXP2101_LDO_CTRL_REG, AXP2101_ALDO1_CTRL_MASK, _speed);
    } else {
        result = bitOff(_addr, AXP2101_LDO_CTRL_REG, AXP2101_ALDO1_CTRL_MASK, _speed);
    }
...
bool AXP2101::set_dcdc1_on_off(bool sw)
{
    ...
    if (sw) {
        result = bitOn(AXP2101_ADDR, AXP2101_DCDC_CTRL_REG, AXP2101_DCDC1_CTRL_MASK, _speed);
    } else {
        result = bitOff(AXP2101_ADDR, AXP2101_DCDC_CTRL_REG, AXP2101_DCDC1_CTRL_MASK, _speed);
    }
...
bool AXP2101::set_dcdc2_on_off(bool sw)
{
    ...
    if (sw) {
        result = bitOn(AXP2101_ADDR, AXP2101_DCDC_CTRL_REG, AXP2101_DCDC2_CTRL_MASK, _speed);
    } else {
        result = bitOff(AXP2101_ADDR, AXP2101_DCDC_CTRL_REG, AXP2101_DCDC2_CTRL_MASK, _speed);
    }
...
bool AXP2101::set_dcdc3_on_off(bool sw)
{
    ...
    if (sw) {
        result = bitOn(AXP2101_ADDR, AXP2101_DCDC_CTRL_REG, AXP2101_DCDC3_CTRL_MASK, _speed);
    } else {
        result = bitOff(AXP2101_ADDR, AXP2101_DCDC_CTRL_REG, AXP2101_DCDC3_CTRL_MASK, _speed);
    }
...
{   
  ...
  if (temp > 3500)
    temp = 3500;    
  if (writeRegister8(AXP2101_ADDR, AXP2101_ALDO4_VOLTAGE_REG, (temp - 500) / 100, _speed)) {
      return true;
  } else {
      return false;
  }            
...
{   
  ...
  if (temp > 3400)
    temp = 3400;  
  if (writeRegister8(AXP2101_ADDR, AXP2101_DCDC1_VOLTAGE_REG, (temp - 1500) / 100, _speed)) {
      return true;
  } else {
      return false;
  }            
